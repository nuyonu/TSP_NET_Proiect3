...
namespace PhotoManager.Forms
{
    ...
    public partial class AddPhotos : Form
    {
        ...
        private void ButtonLoad_Click(object sender, EventArgs e)
        {
            ...
            if (mode == Mode.Directory)
            {
                ...
                if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
                    ...
                    {
                        if (photosPath.Contains(photoPath) || photoManagerServiceClient.AlreadyInDatabaseAndNotDeleted(photoPath))
                            continue;
                        else
        ...
        private void ButtonAddToDatabase_Click(object sender, EventArgs e)
        {
            ...
            MediaType type = VIDEO_EXTENSIONS.Contains("*" + format)  ? MediaType.Video : MediaType.Photo;
            ...
            photoManagerServiceClient.SaveMedia(media);
